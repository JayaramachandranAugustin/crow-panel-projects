...
void ui_Screen1_screen_init(void)
{
    ...
    lv_img_set_src(ui_Image1, &ui_img_bulb_png);
    lv_obj_set_width(ui_Image1, lv_pct(97));
    lv_obj_set_height(ui_Image1, lv_pct(134));
    ...
    lv_obj_set_x(ui_Button1, 88);
    lv_obj_set_y(ui_Button1, -59);
    lv_obj_set_align(ui_Button1, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_Button1, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_clear_flag(ui_Button1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_Button1, lv_color_hex(0xFFC200), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_Button2, lv_color_hex(0x616061), LV_PART_MAIN | LV_STATE_DEFAULT);
