...
void ui_event_Button1(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_RELEASED) {
        _ui_image_set_property(ui_Image1, _UI_IMAGE_PROPERTY_IMAGE, & ui_img_bulb_png);
        bulb_on(e);
    }
}
...
void ui_event_Button2(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_RELEASED) {
        _ui_image_set_property(ui_Image1, _UI_IMAGE_PROPERTY_IMAGE, & ui_img_bulb_off_png);
    }
    if(event_code == LV_EVENT_RELEASED) {
        bulb_off(e);
    }
...
void ui_Screen1_screen_init(void)
{
    ...
    lv_img_set_src(ui_Image1, &ui_img_bulb_off_png);
    ...
    lv_obj_set_style_bg_color(ui_Button1, lv_color_hex(0x47C645), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_Button2, lv_color_hex(0xF15D33), LV_PART_MAIN | LV_STATE_DEFAULT);
